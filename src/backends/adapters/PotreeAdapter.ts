...
export class PotreeAdapter implements IMapBackend {
  readonly type: BackendType = 'potree'
  readonly capabilities: BackendCapabilities = BACKEND_CAPABILITIES.potree
  ...
  async initialize(_container: HTMLElement, _options: MapOptions = {}): Promise<void> {
    throw new Error('Potree adapter not yet implemented')
  }
