...
export class MapboxAdapter implements IMapBackend {
  readonly type: BackendType = 'mapbox'
  readonly capabilities: BackendCapabilities = BACKEND_CAPABILITIES.mapbox
