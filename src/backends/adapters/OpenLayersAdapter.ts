...
export class OpenLayersAdapter implements IMapBackend {
  readonly type: BackendType = 'openlayers'
  readonly capabilities: BackendCapabilities = BACKEND_CAPABILITIES.openlayers
  ...
  async initialize(_container: HTMLElement, _options: MapOptions = {}): Promise<void> {
    throw new Error('OpenLayers adapter not yet implemented')
  }
