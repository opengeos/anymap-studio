...
export class DeckGLAdapter implements IMapBackend {
  readonly type: BackendType = 'deckgl'
  readonly capabilities: BackendCapabilities = BACKEND_CAPABILITIES.deckgl

  private deck: unknown = null
  ...
  async initialize(_container: HTMLElement, _options: MapOptions = {}): Promise<void> {
    throw new Error('DeckGL adapter not yet implemented')
  }
