    ...
    <div className="flex flex-col px-3 py-2">
      ...
      {showUrlDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-8">
          <div className="w-full max-w-lg rounded-2xl bg-slate-800 p-8 shadow-2xl border border-slate-600">
            <h3 className="mb-8 text-xl font-semibold text-slate-100">Add Layer from URL</h3>

            <div className="mb-6">
              <label className="mb-3 block text-sm font-medium text-slate-300">Layer Type</label>
              <select
                value={urlType}
                onChange={(e) => setUrlType(e.target.value as typeof urlType)}
                className="w-full rounded-lg border border-slate-500 bg-slate-700 px-4 py-3 text-sm text-slate-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              >
            ...
            <div className="flex justify-end gap-4 pt-4 border-t border-slate-700">
              ...
              <button
                ...
                className="rounded-lg bg-blue-600 px-6 py-3 text-sm font-medium text-white hover:bg-blue-500 disabled:opacity-50 transition-colors"
              >
